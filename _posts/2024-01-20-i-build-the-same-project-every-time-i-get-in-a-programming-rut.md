...
Left to my own devices, I will try to solve the <a target="_blank" href="https://en.wikipedia.org/wiki/Knight's_tour">knight's tour problem</a> <a target="_blank" href="https://github.com/OulipianSummer/Perecian">over</a>, and <a target="_blank" href="/posts/joust" >over</a>, and <a target="_blank" href="https://github.com/OulipianSummer/rudrata">over</a> again. The exact implementation details differ slightly depending on what I'm learning at the time, but the core idea remains: *how do you get this little horsey guy around the chessboard real quick?*
